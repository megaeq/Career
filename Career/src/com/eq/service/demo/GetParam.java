...
public class GetParam extends BaseAction {
	...
	public String gerParam(@RequestParam("age1") String a,
			@RequestParam("name1") String b, Map<String, Object> map) {
		...
		JFreeChart chart = JfreechartUtils.createBar3DChart(dataset, "第一季度月份图",
				"月份", "销售量", 960, 540);
		map.put("imagePath", JfreechartUtils.toFile(chart, dirpath, urlpath,
				"test", 960, 540));
		return "page/hello";
	}
