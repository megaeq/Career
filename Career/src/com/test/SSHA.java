...
public class SSHA {
    ...
    public static void main(String[] args)
	{
		...
		/*String sshaPasswordString = "{SSHA}9f0b/mlE4VXykfqOJpJ3Lm++1WFUWTm8fDXIKQ==";
		String sshaPasswordString2 = encodePassword(password);
		if(sshaPasswordString.equals(sshaPasswordString2)) {
			System.out.println(sshaPasswordString);
			System.out.println(sshaPasswordString2);
			System.out.println("{SSHA}QQoNaDG1d3EUmiqkQfpIp6BaH26Wancpg1/8rQ==");
		...
		String sshaPasswordString = encodePassword(password);
		String sshaPasswordString2 = "{SSHA}9f0b/mlE4VXykfqOJpJ3Lm++1WFUWTm8fDXIKQ==";
		System.out.println(sshaPasswordString);
		System.out.println(checkPassword(password, sshaPasswordString));
		System.out.println(checkPassword(password, sshaPasswordString2));
	}
}
