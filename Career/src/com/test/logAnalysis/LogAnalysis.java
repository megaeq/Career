 ...
 * @title LogAnalysis.java
 * @package com.test.logAnalysis
 * @compiler JDK1.6
 * @description TODO
 * @author Mega.Yan
 * @date 2015-9-6 上午9:18:56
 * @version V1.0  
 */
package com.test.logAnalysis;
 ...
 * @date 2015-9-6 上午9:18:56
 */
public class LogAnalysis extends Thread
{
	private Logger logger = LoggerFactory.getLogger(LogAnalysis.class);
	 ...
	 */
	public LogAnalysis(File file, long sampleInterval, boolean startAtBeginning)
	{
		this.logfile = file;
