...
public class CompressPic
{
	...
	public static void main(String[] arg)
	{
		...
		System.out.println("输入的图片大小：" + mypic.getPicSize("D:\\abd7bb93f2fa57ae011e7fdea1ca2310.jpg") / 1024 + "KB");
		int count = 0; // 记录全部图片压缩所用时间
		for (int i = 0; i < 100; i++)
		{
			int start = (int) System.currentTimeMillis(); // 开始时间
			mypic.compressPic("D:\\", "D:\\test\\", "abd7bb93f2fa57ae011e7fdea1ca2310.jpg", "r1" + i + ".jpg", 120, 120, true);
